<template>
  <div class="wrap">
    <!-- <img id="finalImg" src="/img/user.png" alt="上传和截取到的图片会替换掉id为finalImg的图片" /> -->
    <button id="replaceImg" class="l-btn">获取人像</button>
    <!--图片裁剪框 start-->
      ...
      <div class="tailoring-content">
        ...
        <div class="tailoring-content-two">
          <div class="tailoring-box-parcel">
            ...
            <div id="showImg" style="width: 100%; height: 100%">
              <img id="tailoringImg" />
            </div>
          </div>
        ...
        <div class="tailoring-content-three">
          ...
          <button class="l2-btn sureCut" @click="closeTailor(this)">
            取消
          </button>
        </div>
      </div>
  ...
  mounted() {
    ...
    $("#sureCut").on("click", function () {
      ...
      $.post(
        // "../Info",
        "/admin/userinfo",
        { op: "takePhoto", base64url: base64url },
        function (data) {
          var result = parseInt($.trim(data.result));
          if (result == -1) {
            $.messager.show({
              title: "温馨提示",
              msg: "输入的信息不完整,确认后重新提交。",
              timeout: 3000,
              showType: "slide",
            });
          } else if (result > 0) {
    ...
    document.getElementById("capture").addEventListener("click", function () {
      ...
      context.drawImage(video, 0, 0, 520, 450);
      mediaStreamTrack && mediaStreamTrack.stop();
      $("#tailoringImg").cropper(
        "replace",
    ...
    _this.selectImg = selectImg;
    _this.closeTailor = closeTailor;
  },
  methods: {
    selectImg() {},
    closeTailor() {},
